...
#install.packages("RCurl")<- u need to install it for processing form data 
...
browseURL("https://indefinities.github.io/fempow/",
          browser = "C:/Users/ruhif/AppData/Local/Google/Chrome/Application/chrome.exe")


user_input<-GET("https://indefinities.github.io/fempow/loan-comparison.html?")
